...
extern "C"
uint8_t * exec_block_ee(ee::jit::EE_JIT64 & jit, ee::EmotionEngine & ee)
{
...
namespace ee
{
    namespace jit
    {
        ...
        void vu0_start_program(vu::VectorUnit& vu0, uint32_t addr)
        {
            vu0.start_program(addr, 0);
        }

        uint32_t vu0_read_CMSAR0_shl3(vu::VectorUnit& vu0)
        {
