...
/**
  * These tables (as well as the swizzling algorithms in gsthread.cpp) were taken from PCSX2's GSdx plugin.
  * Much better than my solution (which essentially recalculated tables every time) :)
  */

namespace gs
{
    const uint8_t blockTable32[4][8] =
    {
        {  0,  1,  4,  5, 16, 17, 20, 21},
        {  2,  3,  6,  7, 18, 19, 22, 23},
    ...
    const uint8_t blockTable32Z[4][8] =
    {
    ...
    const uint8_t blockTable16[8][4] =
    {
        {  0,  2,  8, 10 },
        {  1,  3,  9, 11 },
        {  4,  6, 12, 14 },
    ...
    const uint8_t blockTable16S[8][4] =
    {
        {  0,  2, 16, 18 },
        {  1,  3, 17, 19 },
        {  8, 10, 24, 26 },
    ...
    const uint8_t blockTable16Z[8][4] =
    {
        { 24, 26, 16, 18 },
        { 25, 27, 17, 19 },
        { 28, 30, 20, 22 },
    ...
    const uint8_t blockTable16SZ[8][4] =
    {
        { 24, 26,  8, 10 },
        { 25, 27,  9, 11 },
        { 16, 18,  0,  2 },
    ...
    const uint8_t columnTable32[8][8] =
    {
        {  0,  1,  4,  5,  8,  9, 12, 13 },
        {  2,  3,  6,  7, 10, 11, 14, 15 },
    ...
    const uint8_t columnTable16[8][16] =
    {
    ...
    const uint8_t columnTable8[16][16] =
    {
    ...
    const uint16_t columnTable4[16][32] =
    {
